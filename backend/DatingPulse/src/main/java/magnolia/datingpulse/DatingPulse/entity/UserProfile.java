...
public class UserProfile {
    ...
    private String profilePictureUrl; // Changed from pp to match schema
    
    // Note: avatarThumbnail field doesn't exist in schema - removing for now
    ...
    private String locationCountry; // Changed from country to match schema
    
    // Note: region field doesn't exist in schema - removing for now
    // @Size(max = 100, message = "Region must not exceed 100 characters")
    // private String region;
    
    @Column(name = "location_city", length = 100)
    @Size(max = 100, message = "City must not exceed 100 characters")
    private String locationCity; // Changed from city to match schema
